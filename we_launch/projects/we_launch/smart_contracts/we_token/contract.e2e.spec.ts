...
import { WeTokenFactory } from '../artifacts/we_token/WeTokenClient'

describe('WeToken contract', () => {
  ...
  const deploy = async (account: Address) => {
    const factory = localnet.algorand.client.getTypedAppFactory(WeTokenFactory, {
